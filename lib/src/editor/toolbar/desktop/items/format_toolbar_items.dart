...
final List<ToolbarItem> markdownFormatItems = [
  _FormatToolbarItem(id: 'underline', name: 'underline'),
  _FormatToolbarItem(id: 'bold', name: 'bold'),
  _FormatToolbarItem(id: 'italic', name: 'italic'),
  _FormatToolbarItem(id: 'strikethrough', name: 'strikethrough'),
  _FormatToolbarItem(id: 'code', name: 'code'),
];
