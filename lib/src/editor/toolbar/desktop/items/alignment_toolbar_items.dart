...
final List<ToolbarItem> alignmentItems = [
  _AlignmentToolbarItem(id: 'align_left', name: 'left', align: 'left'),
  _AlignmentToolbarItem(id: 'align_center', name: 'center', align: 'center'),
  _AlignmentToolbarItem(id: 'align_right', name: 'right', align: 'right'),
];
