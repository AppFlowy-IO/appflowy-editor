...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "backgroundColorBlue": MessageLookupByLibrary.simpleMessage(
      "Blue background",
    ),
    ...
    "backgroundColorGray": MessageLookupByLibrary.simpleMessage(
      "Gray background",
    ),
    "backgroundColorGreen": MessageLookupByLibrary.simpleMessage(
      "Green background",
    ),
    "backgroundColorOrange": MessageLookupByLibrary.simpleMessage(
      "Orange background",
    ),
    "backgroundColorPink": MessageLookupByLibrary.simpleMessage(
      "Pink background",
    ),
    "backgroundColorPurple": MessageLookupByLibrary.simpleMessage(
      "Purple background",
    ),
    ...
    "cmdConvertToLink": MessageLookupByLibrary.simpleMessage("Convert to link"),
    "cmdConvertToParagraph": MessageLookupByLibrary.simpleMessage(
      "convert to paragraph",
    ),
    "cmdCopySelection": MessageLookupByLibrary.simpleMessage("Copy selection"),
    "cmdCutSelection": MessageLookupByLibrary.simpleMessage("Cut selection"),
    ...
    "cmdExitEditing": MessageLookupByLibrary.simpleMessage("exit editing mode"),
    ...
    "cmdMoveCursorUp": MessageLookupByLibrary.simpleMessage("move cursor up"),
    ...
    "cmdPasteContent": MessageLookupByLibrary.simpleMessage("paste content"),
    ...
    "cmdScrollPageUp": MessageLookupByLibrary.simpleMessage("scroll page up"),
    ...
    "cmdToggleItalic": MessageLookupByLibrary.simpleMessage("toggle italic"),
    ...
    "emptySearchBoxHint": MessageLookupByLibrary.simpleMessage(
      "Enter a pattern",
    ),
    ...
    "listItemPlaceholder": MessageLookupByLibrary.simpleMessage("List item"),
