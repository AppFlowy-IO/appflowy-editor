  ...
  group('numbered list component', () {
    ...
    testWidgets('the number of the numbered list should be ascending', (
      ...
      final editor = tester.editor
        ..addNode(numberedListNode(delta: Delta()..insert(text), number: 100))
        ..addNode(numberedListNode(delta: Delta()..insert(text)))
        ..addNode(numberedListNode(delta: Delta()..insert(text), number: 200));
    ...
    testWidgets(
      ...
      (tester) async {
        final editor = tester.editor
          ..addNode(numberedListNode(delta: Delta()..insert(text), number: 1))
          ..addEmptyParagraph()
          ..addNode(numberedListNode(delta: Delta()..insert(text), number: 100))
          ..addNode(numberedListNode(delta: Delta()..insert(text)));
        await editor.startTesting();
