  ...
  group('floating toolbar', () {
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        final List<Widget> toolbarItemWidgets =
            floatingToolbarContainer.children;
        expect(
    ...
    testWidgets(
      'select multiple line should show bullet and number list item',
      (tester) async {
        final editor = tester.editor..addParagraphs(3, initialText: text);
        await editor.startTesting(withFloatingToolbar: true);
        ...
        final bulletListItem = find.byWidgetPredicate(
          (w) =>
              w is SVGIconItemWidget && w.iconName == 'toolbar/bulleted_list',
        );
        final numberListItem = find.byWidgetPredicate(
          (w) =>
              w is SVGIconItemWidget && w.iconName == 'toolbar/numbered_list',
        );
        expect(floatingToolbar, findsOneWidget);
