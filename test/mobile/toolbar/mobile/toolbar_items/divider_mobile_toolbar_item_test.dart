  ...
  group('dividerMobileToolbarItem', () {
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          Material(
            child: MobileAppWithToolbarWidget(
              ...
              toolbarItems: [dividerMobileToolbarItem],
            ),
          ),
        );
        ...
        expect(node?.type == ParagraphBlockKeys.type, true);
      },
    );
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        var selection = Selection.collapsed(
          Position(path: [originalPath], offset: 2),
        );
        ...
        expect(node?.type == DividerBlockKeys.type, true);
      },
    );
  });
}
