...
void main() {
  group('mobile_text_span_decorator_for_attribute.dart', () {
    group('Link attribute', () {
      ...
      testWidgets('Show edit link dialog after long tap the link', (
        WidgetTester tester,
      ) async {
        const text = 'Appflowy website';
        const address = 'https://appflowy.com/';
      ...
      testWidgets('Show error prompt when input is empty', (
        WidgetTester tester,
      ) async {
        const text = 'Appflowy website';
        const address = 'https://appflowy.com/';
      ...
      testWidgets('Change the link info correctly by link edit menu', (
        WidgetTester tester,
      ) async {
        const text = 'Appflowy website';
      ...
      testWidgets('Remove the link successfully by link edit menu', (
        WidgetTester tester,
      ) async {
        const text = 'Appflowy website';
        const address = 'https://appflowy.com/';
      ...
      testWidgets('Edit link menu disappeaar after tap outside the menu', (
        WidgetTester tester,
      ) async {
        const text = 'Appflowy website';
        const address = 'https://appflowy.com/';
