  ...
  group('image_node_builder.dart', () {
    testWidgets('render image node', (tester) async {
      mockNetworkImagesFor(() async {
        ...
        final editor = tester.editor
          ..insertTextNode(text)
          ..insertImageNode(src, type: 'network')
          ..insertTextNode(text);
    ...
    testWidgets('render image align', (tester) async {
      mockNetworkImagesFor(() async {
        ...
        final editor = tester.editor
          ..insertTextNode(text)
          ..insertImageNode(src, align: 'left', width: 100, type: 'network')
          ..insertImageNode(src, align: 'center', width: 100, type: 'network')
          ..insertImageNode(src, align: 'right', width: 100, type: 'network')
          ..insertTextNode(text);
        await editor.startTesting();
        await tester.pumpAndSettle();
